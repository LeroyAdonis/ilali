      ...
      <main className="flex-1">
        ...
        <section className="bg-paper-warm px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <div className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-sunset-100 mb-6">
              <Heart className="h-8 w-8 text-sunset-600" />
            </div>
        ...
        <section className="bg-paper-warm py-16 sm:py-20">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-2xl bg-white border border-ink/10 p-8 sm:p-12 shadow-sm">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {[
                  ...
                  <div key={item.label} className="flex items-center gap-2 text-sm text-ink-soft">
        ...
        <section className="py-16 sm:py-20">
          <div className="mx-auto max-w-lg px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 rounded-xl border border-ink/10 bg-paper-warm p-4 text-center">
