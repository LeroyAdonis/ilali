          ...
          <div className="rounded-2xl bg-gradient-to-br from-ilali-50 to-ilali-100 p-8 sm:p-10">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full border border-ink/10 bg-white px-6 py-3 text-sm font-semibold text-ink-soft hover:border-ilali-400 hover:text-ilali-600 transition-colors"
              >
                Learn more
              </Link>
            </div>
