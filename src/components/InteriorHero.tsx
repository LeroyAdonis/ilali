...
export default function InteriorHero({
  ...
  return (
    <header className="relative overflow-hidden w-full flex items-center border-b border-ink/10" style={{ aspectRatio: "1344 / 768", maxHeight: "50vh" }}>
      ...
      <div className="absolute right-[6%] bottom-[15%] z-[3] hidden sm:flex w-[110px] h-[110px] flex-col items-center justify-center rounded-full border-2 border-gold bg-[rgba(255,253,253,0.88)] shadow-[0_10px_36px_rgba(16,49,46,0.16)] backdrop-blur-sm rotate-[-6deg]">
      ...
      <div className="absolute right-[14px] top-[84px] z-[3] flex sm:hidden w-[84px] h-[84px] flex-col items-center justify-center rounded-full border-2 border-gold bg-[rgba(255,253,253,0.88)] shadow-[0_10px_36px_rgba(16,49,46,0.16)] backdrop-blur-sm rotate-[-6deg]">
