    ...
    return (
      <form onSubmit={handleSubmit} className="relative w-full max-w-xs">
        ...
        <input
          ...
          className="w-full rounded-full border border-slate-200 bg-slate-50 py-2 pl-9 pr-10 text-sm text-slate-700 placeholder-slate-400 focus:border-ilali-400 focus:outline-none focus:ring-2 focus:ring-ilali-100 transition-colors"
        />
        {isNlMode && (
          <Sparkles
  ...
  return (
    <form onSubmit={handleSubmit} className="relative w-full max-w-2xl mx-auto">
      ...
      <input
        ...
        className={`w-full rounded-full border bg-white py-4 pl-14 pr-12 text-base text-slate-700 placeholder-slate-400 shadow-md focus:border-ilali-400 focus:outline-none focus:ring-2 focus:ring-ilali-100 transition-colors ${
          isNlMode ? "border-ilali-300" : "border-slate-200"
        }`}
      />
      {isNlMode && (
        <Sparkles
